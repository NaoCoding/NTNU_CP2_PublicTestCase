...
int main(){
    ...
    printf("%d\n" , AddSingleBlock(block , 1 , 1 , 1 , 0 , 0 , 0));
    printf("%d\n" , AddSingleBlock(block , 2 , 2 , 2 , 0 , 0 , 0));
    printf("%d\n" , AddSingleBlock(block , 3 , 3 , 3 , 0 , 0 , 0));
    printf("%d\n" , DeleteSingleBlock(block , 3 , 3 , 3));
    printf("%d\n" , DeleteSingleBlock(block , 2 , 2 , 2));
